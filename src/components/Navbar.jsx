...
const Navbar = () => {
  ...
  return (
    <div className={`px-15 md:px-8  backdrop-blur-[2px] border-b border-fuchsia-950 w-full h-16  fixed top-0 left-0 z-100 flex justify-between md:items-center transition-all duration-500 ${extendNavbar ? "h-80" : "h-16 "}`}>
