      ...
      <div className="flex flex-col  h-[680px] w-[1095px] p-4 justify-center items-center text-gray-300">
        ...
        <div className="grid grid-flow-row gap-10 grid-cols-2 lg:grid-cols-4 ">
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse ">
            <div>
              <img src="/src/assets/images/js.png" alt="JavaScript" className="w-7 rounded "/>
            </div>
            <h3>JavaScript</h3>
          </div>
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse">
            <div>
              <img src="/src/assets/images/html-5.png" alt="HTML" className="w-7 rounded"/>
            </div>
            <h3>HTML</h3>
          </div>
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse">
            <div>
              <img src="/src/assets/images/css.png" alt="CSS" className="w-7 rounded"/>
            </div>
            <h3> CSS</h3>
          </div>
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse">
            <div>
              <img src="/src/assets/images/react.png" alt="React" className="w-7 rounded"/>
            </div>
            <h3>React JS</h3>
          </div>
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse">
            <div>
              <img src="/src/assets/images/python.png" alt="Python" className="w-7 rounded"/>
            </div>
            <h3>Python</h3>
          </div>
          ...
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse">
            <div>
              <img src="/src/assets/images/git.png" alt="Git" className="w-7 rounded"/>
            </div>
            <h3>Git</h3>
          </div>
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse">
            <div>
              <img src="/src/assets/images/mySql.png" alt="MySQL" className="w-7 rounded"/>
            </div>
            <h3>MySQL</h3>
          </div>
          <div className="flex gap-2 justify-center items-center w-40 h-16 inset-shadow-sm inset-shadow-fuchsia-950  shadow-fuchsia-950  rounded-lg  border-fuchsia-950 transition-all transform hover:border-2 hover:shadow-lg hover:scale-115 hover:animate-none ease-in-out animate-pulse">
            <div>
              <img src="/src/assets/images/tailwind.png" alt="Tailwind" className="w-7 rounded"/>
            </div>
            <h3>Tailwind</h3>
          </div>
